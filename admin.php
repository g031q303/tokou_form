...
if( $mysqli->connect_errno ) {
	...
	$sql = "SELECT id,view_name,message,post_date,modified FROM message ORDER BY post_date DESC";
...
<body>
<form>
<input type="button" onClick="location.href='index.php'" value="TOPページへ">
</form>
<h1>管理ページ</h1>
